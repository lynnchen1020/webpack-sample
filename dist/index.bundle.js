...
/***/ function(module, exports, __webpack_require__) {
	...
	var HelloMessage = function (_React$Component) {
	  ...
	  _createClass(HelloMessage, [{
	    ...
	    value: function render() {
	      ...
	      var items = this.state.data.map(function (i) {
	        // Key should be specified inside the array.
	        return React.createElement(
	          'span',
	          { className: 'box', onClick: _this2.add },
	          i
	        );
	      });
	...
	ReactDOM.render(React.createElement(HelloMessage, { 'class': 'header' }), document.getElementById('example'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _errorMessage.use)(function (error) {
	  error.msg = error.msg + '[' + error.code + ']';
	});

	var m_error = { code: 10100, msg: 'test' };

	var m = (0, _errorMessage.parse)(m_error).getObject();
